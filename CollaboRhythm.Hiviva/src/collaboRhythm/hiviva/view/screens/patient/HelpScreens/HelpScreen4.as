package collaboRhythm.hiviva.view.screens.patient.HelpScreens
{
	...
	public class HelpScreen4 extends HivivaPatientHelpScreen implements IhelpScreen
	{
		private var __screenName : String;
        private var __sNav : ScreenNavigator;
        private var __HivivaPatient_help_help_Screen:Object
		public function HelpScreen4(__sNav: ScreenNavigator   , __HivivaPatient_help_help_Screen:Object =null )
		{
			super();
