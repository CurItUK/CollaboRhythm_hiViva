package collaboRhythm.hiviva.view.screens.patient.help
{
	...
	public class HivivaPatient_help_SeeAdherence_Screen extends Screen
	{
		...
		private var _pageString : String  = "Your homepage photo will become clearer as your daily adherence level increases. " +
				"If you are connected to a care provider, they can also monitor your adherence via " +
				"their version of the application."

		public function HivivaPatient_help_SeeAdherence_Screen()
		{
			super();
		}
		...
		override protected function initialize():void
			{
				...
				this._header.title = "See Adherence"//  this._title;
