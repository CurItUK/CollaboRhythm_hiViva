package collaboRhythm.hiviva.view.screens.patient.help
{
	...
	public class HivivaPatient_help_Create_Profile_Screen extends Screen
	{
		...
		private var _pageString : String  = "You will need to create a profile in order to connect to a care provider. " +
				"This requires you to record your name so that your connection is able to identify you against your app I.D.";

		public function HivivaPatient_help_Create_Profile_Screen()
		{
			super();
		}
		...
		override protected function initialize():void
			{
				...
				this._header.title = "Create Profile"//  this._title;
		...
		private function backBtnHandler():void
				{
					...
					this.owner.showScreen(HivivaScreens.PATIENT_HELP_GETTINGSTARTED_SCREEN);
				}
