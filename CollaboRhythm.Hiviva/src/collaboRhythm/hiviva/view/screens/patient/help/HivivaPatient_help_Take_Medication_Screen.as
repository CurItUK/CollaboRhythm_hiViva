package collaboRhythm.hiviva.view.screens.patient.help
{
	...
	public class HivivaPatient_help_Take_Medication_Screen extends Screen
	{
		...
		private var _pageString : String  = "Record when you take your medicine by ticking the checkbox next to tablets " +
				"you have taken that day.";

		public function HivivaPatient_help_Take_Medication_Screen()
		{
			super();
		}
		...
		override protected function initialize():void
			{
				...
				this._header.title = "Take Medication"//  this._title;
