	...
	public class HCPScreenManager extends HivivaPatientHelpScreen
	{
		...
		public function getStatus(s:String):String{
				...
				switch(s)
						{
					case "help1" :
				 	__s = String(HivivaScreens.HCP_HELP_HELP1_SCREEN);
						break;
					case "help2" :
						__s = String(HivivaScreens.HCP_HELP_HELP2_SCREEN);
					break;
					case "help3" :
						__s = String(HivivaScreens.HCP_HELP_HELP3_SCREEN);
						break;
					case "help4" :
						__s = String(HivivaScreens.HCP_HELP_HELP4_SCREEN);
						break;
					case "help5" :
						__s = String(HivivaScreens.HCP_HELP_HELP5_SCREEN);
						break;
					case "help6" :
						__s = String(HivivaScreens.HCP_HELP_HELP6_SCREEN);
						  	break;
				}
				return __s
			}
