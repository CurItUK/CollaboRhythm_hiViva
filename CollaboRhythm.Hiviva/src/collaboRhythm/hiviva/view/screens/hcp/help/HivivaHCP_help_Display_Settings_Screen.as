package collaboRhythm.hiviva.view.screens.hcp.help
{
	...
	public class HivivaHCP_help_Display_Settings_Screen extends Screen
	{
		...
		private var _pageString : String  = "The display settings dictate how your connected patients are ranked on your" +
				" homepage. You can prioritize adherence or tolerability values in either ascending or descending order.";




		public function HivivaHCP_help_Display_Settings_Screen()
		{
			super();
		}
//HivivaPatient_help_Connect_To_Care_Provider_Screen
		...
		override protected function initialize():void
			{
				...
				this._header.title = "Display Settings"//  this._title;
		...
		private function backBtnHandler():void
				{
					this.owner.showScreen(HivivaScreens.HCP_HELP_GETTINGSTARTED_SCREEN);
				}
