	...
	public class Main extends Sprite
	{
		...
		private function initPatientNavigator():void
		{
			...
			if(!this._appReset)
			{
				...
				this._patientNav.addScreen(HivivaScreens.PATIENT_MEDICATION_SCREEN, new ScreenNavigatorItem(HivivaPatientTakeMedsScreen , null , {applicationController:_applicationController}));
