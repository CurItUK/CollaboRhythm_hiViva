package collaboRhythm.hiviva.controller
{
	...
	public class HivivaLocalStoreController extends EventDispatcher
	{
		...
		{
			service.addEventListener(LocalDataStoreEvent.PASSCODE_SAVE_DETAILS_COMPLETE , passcodeSaveCompleteHandler);
			service.savePasscodeDetails(passcode , answer , questionId);
		}

		private function passcodeSaveCompleteHandler(event:LocalDataStoreEvent):void
		{
			service.removeEventListener(LocalDataStoreEvent.PASSCODE_SAVE_DETAILS_COMPLETE , passcodeSaveCompleteHandler);
		...
		{
			service.addEventListener(LocalDataStoreEvent.PASSCODE_SAVE_DETAILS_COMPLETE , passcodeDisableCompleteHandler);
			service.disablePasscodeDetails();
		}

		private function passcodeDisableCompleteHandler(event:LocalDataStoreEvent):void
		{
			service.removeEventListener(LocalDataStoreEvent.PASSCODE_SAVE_DETAILS_COMPLETE , passcodeDisableCompleteHandler);
			this.dispatchEvent(new LocalDataStoreEvent(LocalDataStoreEvent.PASSCODE_SAVE_DETAILS_COMPLETE));
		}
